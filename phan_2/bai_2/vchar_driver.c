...
#include<linux/fs.h> /*thu vien nay dinh nghia cac ham cap phat va giai phong device number*/
...
static int __init vchar_driver_init(void)
{
	...
	printk("Initialize vchar driver susccessfully\n");
	return 0;
