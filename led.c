...
#define LED_GREEN 7
#define LED_RED 9
#define OFF_SET_CONFIG_REG 0x00

#define OFF_SET_CONFIG 28
#define DATA_REG 0x10

#define BUTTON 8
#define OFFSET_GPIOA 0x04
...
{
	printk("before [0]=%x ---[4]=%x/n",&(gpioa_0_7[0]),&(gpioa_0_7[4])); 
    toggle(LED_GREEN);
	return IRQ_HANDLED;
...
int __init leds_init(void)
{
	...
	/*dang ky entry point voi kernel*/
    ...
    /*interrupt */
    gpioa_0_7 = ioremap(BASE_ADDR + OFFSET_GPIOA, SIZE_GPIOA);
	if(gpioa_0_7 == NULL)
	{
	...
	//Mapping EINT_GPIOA
	ex_gpioa_0_7 = ioremap(BASE_ADDR + OFFSET_EXTERNAL_INTERRUPT_GPIOA, SIZE_EXTERNAL_INTERRUPT_GPIOA);
